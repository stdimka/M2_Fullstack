...
class PostgresManager:
    ...
    def get_page_by_page_num(self, page_num, is_print=True):
        ...
        self.cur.execute("""SELECT COUNT(*) FROM images;""", (offset,))
    ...
    def get_id_by_filename(self, id):
        self.cur.execute("""SELECT filename FROM images WHERE id = %s;""", (id,))
        filename = self.cur.fetchone()[0]
        return filename

    def get_filename_by_id(self, f):
